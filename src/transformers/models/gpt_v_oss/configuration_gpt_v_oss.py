...
class GptVOssConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`GptVOssModel`]. It is used to instantiate a
